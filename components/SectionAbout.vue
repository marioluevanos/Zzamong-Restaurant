<template>    
    <ParallaxContainer tag='section' class='about' data-id='about'>
        ...
        <article class='about-article'>
            ...
            <ParallaxElement :factor='-0.15' class='about-content' ref='aboutContent' v-html='toHTMLParagraphs(about.content)'/>
        </article>

        <aside class='about-aside'>
            <ParallaxElement tag='svg' :factor='-0.2' viewBox="0 0 225 170" class='logo-type'>
                <g ref='logoTypeGroup'>
...
.about-bg {
    position: absolute;
    top: vw(90); bottom: 0; left: vw(90); right: vw(90);
