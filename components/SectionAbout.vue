<template>    
    <ParallaxContainer tag='section' class='about' data-id='about'>
        ...
        <ParallaxElement tag='figure' :factor='-0.1' class='about-bg'>
            <AppIcon type='corner' :class='{[corner]: true}' v-for='corner in ["top", "right", "bottom", "left"]' :key='corner'/>
        </ParallaxElement>

        <ParallaxElement :factor='-0.15' ref='title' tag='h2' v-html='about.title' class='about-title'/>

        <article class='about-article'>
            <ZzamongHaze class='haze left'  :movement='-30' :factor='-1'/>
            <ZzamongHaze class='haze right' :movement='-20' :factor='-0.25'/>
            <ParallaxElement :factor='-0.15' class='about-content' ref='aboutContent' v-html='about.content'/>
        </article>

        <aside class='about-aside'>
            <ParallaxElement tag='svg' :factor='-0.2' :compensate='false' viewBox="0 0 225 170" class='logo-type'>
                <g ref='logoTypeGroup'>
                    <path id="logo-type-bg" d="M6.3,58.6C14.1,70.4,28.5,77,28.5,77c14.4,5.9-20.6,13.4-9,33.1c11.9,20.6,35.6,5.6,35.6,5.6
                    ...
                    <path id="logo-type-first" d="M154.5,78.9c-2.8-5.3-10.6,3.7-10.6,3.7c2.8-8.4,4.1-24.3,4.4-24.6c0.6-4.1,1.9-22.5-10.3-23.1
                    ...
                    <ellipse class="glare" transform="matrix(2.559788e-02 -0.9997 0.9997 2.559788e-02 -18.0094 53.7953)" cx="18.6" cy="36.1" rx="4.7" ry="3.7"/>
                    <ellipse class="glare" transform="matrix(2.629638e-02 -0.9997 0.9997 2.629638e-02 28.3259 124.684)" cx="78.2" cy="47.8" rx="4.7" ry="4.1"/>
                    <path class="glare" d="M22.2,27.4c0,0,5-8.7,14-2.8c8.7,5.6,9,8.7,9,8.7s0.9,5-4.4,4.1s-8.4-7.8-12.8-5.6
                    C24.1,33.6,20.4,31.7,22.2,27.4z"/>
                    <path class="glare" d="M82.1,38.9c0,0,4.7-8.7,14-3.4c9,5.3,9,8.4,9,8.4s1.2,5-4.1,4.4c-5.3-0.9-8.7-7.5-12.8-5.3
                    S80.3,43.6,82.1,38.9z"/>
                    <path class="glare" d="M82.5,28c0,0,9.4-5,23.1,7.2c0,0-6.9,1.2-11.2-2.2C89.6,29.2,86.5,28.6,82.5,28z"/>
                    <path id="logo-type-last" class="st3" d="M218.2,22.1c0.6-17.2-13.4-17.2-22.8-14.4C186,10.5,157,4,143.6,14.6c0,0-11.2,7.5-5.3,18.4
                    ...
                    <ellipse class="glare" transform="matrix(2.599702e-02 -0.9997 0.9997 2.599702e-02 112.4343 185.3525)" cx="151.3" cy="35" rx="3.7" ry="3.4"/>
                    <path class="glare" d="M146.1,25.2c0,0,0-8.7,9.4-10c10-0.9,11.5,1.2,11.5,1.2s4.1,3.4-0.6,5.9
                    c-4.7,2.5-11.9-1.6-13.7,2.5C150.5,28.9,146.7,29.9,146.1,25.2z"/>
                </g>
            </ParallaxElement>
            <ParallaxElement :factor='-0.1' v-html='about.aside' ref='aboutAside'/>
        </aside>
    </ParallaxContainer>
</template>
...
export default {
    ...
    methods: {
        animateSection() {
            ...
            .staggerFromTo(paragraphs, 0.3, {
                autoAlpha: 0
            }, {
                autoAlpha: 1,
                ease: Power3.easeOut
            }, 0.1, 'title+=0.3')
            .staggerFromTo(paragraphs, 2, {
                y: 100,
            }, {
                y: 0,
                ease: Power3.easeOut
            ...
            .fromTo(this.$refs.aboutAside.$el, 0.3, {
                autoAlpha: 0
            }, {
                autoAlpha: 1,
                ease: Power3.easeOut
            ...
            .fromTo(this.$refs.logoTypeGroup, 0.6, {
                autoAlpha: 0
            }, {
                autoAlpha: 1,
                ease: Sine.easeOut
            }, 'title+=0.8')
            .fromTo(this.$refs.logoTypeGroup.parentElement, 2, {
                filter: 'blur(6px)',
            }, {
                filter: 'blur(0px)',
                ease: Bounce.easeOut
            }, 'title+=0.8')
            .fromTo(this.$refs.logoTypeGroup, 2, {
                scale: 3,
...
.about-bg {
    position: absolute;
    top: vw(var(--gutter)); bottom: 0; left: vw(var(--gutter)); right: vw(var(--gutter));
