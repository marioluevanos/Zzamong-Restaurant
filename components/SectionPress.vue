<template>    
    <ParallaxContainer 
        ...
        <ParallaxElement :factor='-0.1' tag='header' class='press-header main-header'>
        ...
        <ParallaxElement :factor='-0.1' tag='header' class='press-header video-header'>
            ...
            >
                    ...
                    <ParallaxContainer class='video-contain'>
                        ...
                        <span :style='{ backgroundColor: `hsla(${5 + (idx * 6)}, 84%, 65%, 1) `}'>
                            <ParallaxElement :factor='-0.15' tag='img' :src='video.img' :alt='video.title'/>
                        </span>
                    </ParallaxContainer>
            </figure>
        </div>
