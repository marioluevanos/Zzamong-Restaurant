...
export const getters = {
  home: state =>
    state.pages.find(page => page.id === 'home') || {
  ...
  location: state =>
    state.pages.find(page => page.id === 'location') || {
      id: 'location',
      title: 'Location',
      address: {
        state: 'CA',
  ...
  about: state =>
    state.pages.find(page => page.id === 'about') || {
      id: 'about',
      content:
  ...
  press: state =>
    state.pages.find(page => page.id === 'press') || {
      ...
      image:
        'https://storage.googleapis.com/zzamong-restaurant.appspot.com/location-photo.jpg',
      links: [
        {
          ...
          source: 'Eater',
          url:
            'https://la.eater.com/maps/korean-chinese-restaurants-los-angeles-map'
        },
        {
          url:
        ...
        {
          url:
            'https://www.latimes.com/food/dailydish/la-dd-korean-chinese-cuisine-los-angeles-20150824-story.html',
          title:
        ...
        {
          url:
            'https://la.eater.com/maps/14-under-the-radar-koreatown-restaurants-to-try-now',
        ...
        },
        {
          source: 'LA Weekly',
          url:
            'https://www.laweekly.com/the-find-champon-noodle-soup-at-hana-ichimonme-in-little-tokyo/',
          title:
      ...
      youtube: [
        ...
        },
        {
          id: 'Q1RO3HGwyfw',
          title:
            'The Spiciest Spots in Ktown!!! - Spicy Challenges w/ Kathythekimchi on KoogleTV - #RainaisCrazy',
          img: 'https://i.ytimg.com/vi/Q1RO3HGwyfw/sddefault.jpg'
        },
        {
          id: 'H9oO7ZTTDr4',
          title:
            '[ENG SUB]매운레벨 10단계 LA 고스트페퍼짜장면 도전먹방  Level 10 Spicy jajangmyeon challenge!',
          img: 'https://i.ytimg.com/vi/H9oO7ZTTDr4/sddefault.jpg'
        },
        {
          id: '1oQrVXMXXLk',
          title:
            '(eng) 🔥LA spicy challenge🔥 ZZAMONG R.I.P. level Ghost pepper Bul-Jjajang mukbang',
        ...
        },
        {
          id: 'OT3yT4Ec1nE',
          title:
            '미국 고스트페퍼 짜장면 10단계 지옥의 먹방🔥 LA Ghost Pepper Jjajangmyeon Level 10 Challenge',
